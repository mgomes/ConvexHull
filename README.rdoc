...
The algorithm is described and a C++ implementation can be found at here[link:http://softsurfer.com/Archive/algorithm_0109/algorithm_0109.htm#Monotone%20Chain].

A sample of this algorithm implemented with Google Maps can be found here[link:http://www.geocodezip.com/map-markers_ConvexHull_Polygon.asp].
